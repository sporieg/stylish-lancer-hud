const baseList = [
  ...
  },
  {
    ...
    description:
      "JAMMED characters can’t:<br />• use comms to talk to other characters;<br />• make attacks, other than IMPROVISED ATTACK, GRAPPLE, and RAM;<br />• take reactions, or take or benefit from tech actions.",
  },
  {
    id: "lockon",
    ...
    description:
      "Hostile characters can choose to consume a character’s LOCK ON condition in exchange for +1 accuracy on their next attack against that character.<br />LOCK ON is also required to use some talents and systems.",
  },
  {
    id: "shredded",
  ...
  },
  {
    ...
    description:
      "The only movement SLOWED characters can make is their standard move, on their own turn – they can’t BOOST or make any special moves granted by talents, systems, or weapons.",
  },
  {
    id: "stunned",
    ...
    description:
      "STUNNED mechs cannot OVERCHARGE, move, or take any actions – including free actions and reactions. Pilots can still MOUNT, DISMOUNT, or EJECT from STUNNED mechs, and can take actions normally.<br />STUNNED mechs have a maximum of 5 EVASION, and automatically fail all HULL and AGILITY checks and saves.",
    changes: [
      {
        key: "system.evasion",
        value: "5",
  ...
  },
  {
    ...
    description:
      "Characters are in the DANGER ZONE when half or more of their heat is filled in. They’re smoking hot, which enables some attacks, talents, and effects.",
  },
  {
    id: "downandout",
    ...
    description:
      "Pilots that are DOWN AND OUT are unconscious and STUNNED – if they take any more damage, they die. They'll regain consciousness and half of their HP when they rest.",
  },
  {
    id: "engaged",
  ...
  },
  {
    ...
    description:
      "Characters become EXPOSED when they’re dealing with runaway heat buildup – their armor is weakened by overheating, their vents are open, and their weapons are spinning down, providing plenty of weak points. All kinetic, explosive, or energy damage taken by EXPOSED characters is doubled, before applying any reductions. A mech can clear EXPOSED by taking the STABILIZE action.",
  },
  {
    id: "hidden",
  ...
  },
  {
    ...
    description:
      "All attacks against INVISIBLE characters, regardless of type, have a 50 percent chance to miss outright, before an attack roll is made. Roll a dice or flip a coin to determine if the attack misses.<br />Additionally, INVISIBLE characters can always HIDE, even without cover.",
  },
  {
    id: "intangible",
